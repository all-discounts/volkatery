                      ...
                      <div>
                        {
                          <a
                            ...
                            title={'telegram'}>
                            <i className='transform hover:scale-125 duration-150 fa-brands fa-instagram dark:hover:text-red-400 hover:text-red-600' />
                          </a>
                        }
                      </div>
                    )}
...
//            </div>
            ...
            <div className='text-xs text-light-500 dark:text-gray-700'>
              Made with
              <a href="https://www.instagram.com/volkatery.shop/" className=' hover:underline'> ❤️</a>
